...
遵循本仓贡献规则：Bug 提供环境与脱敏复现，功能建议说明场景与维护成本，Question 说明已尝试的步骤。路线图由实际需求驱动，不承诺请求交付时间；漏洞走 [SECURITY.md](SECURITY.md)。
